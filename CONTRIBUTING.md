...
```
   git clone https://github.com/YOUR_USERNAME/Nikola-Tesla-Illuminating-Legacies.git
```
...
```
   git remote add upstream https://github.com/eccentriccoder01/Nikola-Tesla-Illuminating-Legacies.git
```
